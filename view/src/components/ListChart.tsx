    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-details">
          ...
          <p>
            <strong>レベル:</strong> {chart.level}
          </p>
          <p>
            <strong>譜面ビュー:</strong>{" "}
            <a
              href={chart.chartViewLink}
              target="_blank"
          ...
          <p>
            <strong>作詞:</strong> {chart.song?.lyrics?.name}
          </p>
          <p>
            <strong>作曲:</strong> {chart.song?.music?.name}
          </p>
          <p>
            <strong>編曲:</strong> {chart.song?.arrangement?.name}
          </p>
          <p>
            <strong>リリース時間:</strong>{" "}
            {chart.song?.releaseTime?.toDate().toLocaleString()}
          </p>
          <p>
            <strong>原曲MV:</strong>{" "}
            <a
              href={chart.song?.originalVideo}
              target="_blank"
              rel="noopener noreferrer"
            >
              {chart.song?.originalVideo}
            </a>
          </p>
          <p>
          ...
          <p>
            <strong>ユニット:</strong>{" "}
            {chart.song?.units?.map((unit) => unit.name).join(", ")}
          </p>
        </div>
      </div>
    </div>
