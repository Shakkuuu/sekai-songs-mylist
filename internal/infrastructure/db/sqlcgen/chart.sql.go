...
const insertChart = `-- name: InsertChart :exec
...
func (q *Queries) InsertChart(ctx context.Context, arg InsertChartParams) error {
	_, err := q.db.ExecContext(ctx, insertChart,
		arg.SongID,
		arg.DifficultyType,
		arg.Level,
		arg.ChartViewLink,
